...
> [!info] 지금은 신규 가입이 막혔거나 이름이 바뀐 것들이 섞여 있습니다
> 그래도 **In-Scope 목록에는 위 이름 그대로 남아 있으니, 표의 역할 구분을 그대로 외우시면 됩니다.**
...
> [!warning] 네 장비 모두 지금은 주문할 수 없습니다
> Snowmobile만 그런 것이 아닙니다. Snow Family라는 항목 자체는 In-Scope 목록에 남아 있어
> **"물리 배송으로 옮긴다"는 개념은 그대로 출제**되니, 위 표는 자릿수 감각만 잡아 두시면 됩니다.
